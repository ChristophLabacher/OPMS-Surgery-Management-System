...
The prototype is optimized for Google Chrome. While it is fully responsive a larger screen is recommended. An internet connection is necessary, since the (fake) surgery data is loaded from a Google Documents spreadsheet.
